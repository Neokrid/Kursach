...
class GroupMembersFrame(tk.Frame):
    def __init__(self, master, subject_details, teacher_id, hui=0):
    ...
    def create_widgets(self):
        tk.Label(self, text=f"Список группы для {self.subject_details[0]} ({self.subject_details[1]})", font=("Helvetica", 16)).pack(pady=10)
        ...
        tk.Button(self, text="Назад", command=lambda: self.master.show_my_subjects_frame(self.teacher_id)).pack(pady=5)

    def load_group_members(self):
        print("load_group_members")
